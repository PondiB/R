...
output: pdf_document
---
# Tutorial: MODIS NDVI Time series Analysis
...
require("knitr")
opts_knit$set(root.dir = "D:/ToBackup/Data/Regional/LDN_Namibia/NDVI_Modis/AOI_NDVI")
```
...
```{r}
setwd("D:/ToBackup/Data/Regional/LDN_Namibia/NDVI_Modis/AOI_NDVI")
```
...
```{r}
NDVI_Otjo_stack <- stack(list.files(getwd(), full.names = TRUE, pattern = ".tif$"))
```
