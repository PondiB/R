...
2.Import the data into R software
3.Insert a temporal ID into the data
4.Create a time series
5.Plot and export graphs for reports

For more details on source of data see <http://pekko.geog.umd.edu/usda/beta/data_new.php>. Otherwise,
