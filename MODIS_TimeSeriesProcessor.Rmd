...
This manual will help you construct a time series using MODIS data from the Global Agriculture Monitoring (GLAM) Project. For more details on see <http://pekko.geog.umd.edu/usda/beta/data_new.php>.

Run the code below bit by bit:
