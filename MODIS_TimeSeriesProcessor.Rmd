...
data input: Processed MODIS rasters
...
### Preliminaries
To install all required packages, you need to first install the packages. Type (within R) install.packages("name of package") (This needs to be done just once.)
...
Import NDVI rasters and create a raster stack
```{r}
