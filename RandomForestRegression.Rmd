...
Add a new column of shrubs more than 1.5m
```{r test-a, cache=FALSE}
...
BushData_clean<-BushData_clean %>% mutate_each(funs(round(.,0)), 
                                               crown_cover, shrubs_less_1.5, 
                                               shrubs_more_1.5_no_stem, shrubs_more_1.5_stem, shrubs_more_1.5)
```
...
Let's plot  some of the variable
```{r test-a, cache=FALSE}
