...
### Objectives
This manual will help you calculate bush density using count data and ndvi+crown cover data as covariates.
At the end of this session, you will be able to:

1.  Import tabular data into R software
2.  Import raster data into R software
3.  Use the point and raster data to construct a random forest model (RF) 
4.  Use the RF model to predict bush density in areas we don't have count data
4.  Test how accurate the model is
...
plot(otji_bd1, main="Density for shrubs less than 1.5m")
...
otji_bd2<-predict(covs, model2, filename="otji_bd2", format='GTiff', type="response", 
        index=1, na.rm=TRUE, progress="window", overwrite=TRUE)
plot(otji_bd2, main="Density for shrubs more than 1.5m")
...
otji_bd3<-predict(covs, model3, filename="otji_bd3", format='GTiff', type="response", 
        index=1, na.rm=TRUE, progress="window", overwrite=TRUE)
plot(otji_bd3, main="Density for all shrubs")
